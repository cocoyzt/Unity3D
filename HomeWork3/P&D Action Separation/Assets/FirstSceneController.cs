...
public class FirstSceneController : MonoBehaviour ,ISceneController, IUserAction{
    ...
    static public GameObject Shore_l;
    static public GameObject Shore_r;
    static public GameObject Boat;
    static public int[] On_Boat = new int[2];
    static public int[] On_Shore_l = new int[6];
    static public int[] On_Shore_r = new int[6];
    static public GameObject[] dp = new GameObject[6];

    static public bool movetheboat;
    static public GameState game_state;
    static public int boat_capicity = 2;
    static public BoatState boat_state = BoatState.STOPLEFT;
